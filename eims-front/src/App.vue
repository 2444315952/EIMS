<template>
  <el-container>
	  <el-header style="height: 55px;background-color: #B3C0D1;color: #333;line-height: 60px;" >
	  		 ...
	  		 <el-menu
	  		  ...
	  		  <el-submenu index="1">
	  			...
	  			<el-menu-item-group>	
	  				...
	  				<el-menu-item index="1-2"><router-link :to="{name:'SmartReplenish'}">智能补货</router-link></el-menu-item>
	  				<el-menu-item index="1-3"><router-link :to="{name:'PurchaseReturnList'}">采购退货</router-link></el-menu-item>
	  				<el-menu-item index="1-4"><router-link :to="{name:'InquiryList'}">询价单</router-link></el-menu-item>
	  				<el-menu-item index="1-5"><router-link :to="{name:'QuotationList'}">报价单</router-link></el-menu-item>
	  			</el-menu-item-group>
	  		  </el-submenu>
	  		  <el-submenu index="2">
	  			<template #title>
	  			...
	  			<el-menu-item-group>	
	  				<el-menu-item index="2-1">销售单</el-menu-item>
	  				<el-menu-item index="2-2">取货单</el-menu-item>
	  				<el-menu-item index="2-3">销售退货</el-menu-item>
	  			</el-menu-item-group>
	  		  </el-submenu>
	  		  <el-submenu index="3">
	  			<template #title>
