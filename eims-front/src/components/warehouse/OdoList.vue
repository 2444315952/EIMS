			...
			<el-container>
				<el-main>
					<el-row>
						...
						<el-col :span="2">
							<el-button @click="$router.push({name:'AddOdo'})" style="float: right;" size="medium"
								type="primary">新增
							</el-button>
						</el-col>
					</el-row>
					...
					<el-table ref="multipleTable" :data="tableData" :height="tableHeight" tooltip-effect="dark"
						...
						<el-table-column prop="stockOutDocunum" label="单据编号" width="100">
						</el-table-column>
						<el-table-column :formatter="dateFormat" label="出库日期" width="130" prop="documentDate">
						</el-table-column>
						<el-table-column prop="warehouseName" label="所属仓库" width="100" show-overflow-tooltip>
						</el-table-column>
						<el-table-column prop="outboundType" label="出库类型" width="120" show-overflow-tooltip>
						</el-table-column>
