		...
		<el-container style="background-color: white;padding-top: 15px;">
			...
			<el-header style="height: 30px;">
				<el-row>
					...
					<el-col :span="16">
						<el-input style="width: 290px;float: left;" placeholder="搜索单据编号/供应商/仓库/业务员"
							v-model="searchInput">
							<template #append>
					...
					<el-col :span="3">
						...
						<el-button style="float: right;" icon="el-icon-plus" size="medium" type="primary"
							@click="toDetail()">新增采购单</el-button>
				...
				<el-table :data="tableData" max-height="477" style="width: 100%;height:477px;"
					...
					<el-table-column label="付款状态" prop="paymentStatus">
						<template #default="scope">
							...
							<p v-if="tableData[scope.$index].paymentStatus == 1">部分付款</p>
							<p v-if="tableData[scope.$index].paymentStatus == 2">全部付款</p>
						</template>
					</el-table-column>
