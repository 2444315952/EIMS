		...
		<el-form :inline="true" :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px"
			...
			<el-row>
				<el-col :span="12">
					<el-breadcrumb separator-class="el-icon-arrow-right" style="padding-bottom: 16px">
						...
						<el-breadcrumb-item><a href="/SupplierList">供应商列表</a></el-breadcrumb-item>
						<el-breadcrumb-item><a href="/">供应商</a></el-breadcrumb-item>
					</el-breadcrumb>
				</el-col>
			...
			<el-container style="background-color: white;padding-top: 15px;">
				...
				<el-main style="background-color: white;">
					<el-row >
						<el-col :span="12">
							<el-form-item label="供应商名" style="float: left;" prop="supplierName">
								<el-input v-model="ruleForm.supplierName" size="medium" ></el-input>
							</el-form-item>
						</el-col>

						<el-col :span="12">
							<el-form-item label="联系人" style="float: left;" prop="contact">
								<el-input v-model="ruleForm.contact" size="medium" ></el-input>
							</el-form-item>
						</el-col>
					...
					<el-row>
                        <el-col :span="12">
							<el-form-item label="联系电话" style="float: left;" prop="contactNumber">
								<el-input v-model="ruleForm.contactNumber" size="medium" ></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="12">
							<el-form-item label="联系地址" style="float: left;" prop="contactAddress">
								<el-input v-model="ruleForm.contactAddress" size="medium" ></el-input>
							</el-form-item>
						</el-col>
							<template #footer>
					...
					<el-table :data="ruleForm.supplierProductList" show-summary max-height="402"
						style="width: 100%;height:402px;">
						<el-table-column label="产品名称" prop="productName">
							<template #default="scope">
								<el-input v-model="ruleForm.supplierProductList[scope.$index].productName"
						...
						<el-table-column label="采购价" prop="purchasePrice">
							<template #default="scope">
								<el-input-number v-model="ruleForm.supplierProductList[scope.$index].purchasePrice"
		...
		methods: {
			...
			productConfirmButton() {
				...
				newData.forEach(detail => {
					...
					this.ruleForm.supplierProductList[this.product.sourceRowIndex] = detail
			...
			addRow() {
				this.ruleForm.supplierProductList.push({});
			},
			removeRow(index) {
				if (this.ruleForm.supplierProductList.length > 1)
					this.ruleForm.supplierProductList.splice(index, 1);
			},
			changePriceOrQuantity(index) {
				const detail = this.ruleForm.supplierProductList[index]
				const subtotal = detail.purchasePrice * detail.purchaseQuantity
				this.ruleForm.supplierProductList[index].purchaseSubtotal = subtotal
			...
			calcTransactionAmount() {
				...
				this.ruleForm.supplierProductList.forEach(detail => {
			...
			submitForm(formName) {
				this.$refs[formName].validate((valid) => {
					if (valid) {
                        ...
                        this.ruleForm.supplierProductList.forEach(supplier=>{
                            supplier.productPrice = supplier.purchasePrice
                        })
