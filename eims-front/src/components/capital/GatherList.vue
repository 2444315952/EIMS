  ...
  <div id="PurchaseList">
    <el-row>
      ...
      >
        ...
        <el-breadcrumb-item
          ><a href="/PurchaseList">收款单列表</a></el-breadcrumb-item
        >
      </el-breadcrumb>
    </el-row>
    ...
    <el-container style="background-color: white; padding-top: 15px">
      ...
      <el-main style="background-color: white">
        ...
        >
          ...
          <el-table-column label="单据编号" width="158" prop="gatherDocunum">
          </el-table-column>
          <el-table-column
            label="单据日期"
            prop="documentDate"
          ...
          <el-table-column label="销售单据编号" width="162" prop="saleDocunum">
          </el-table-column>
          ...
          <el-table-column fixed="right" label="操作" width="130">
            <template #default="scope">
              <el-button
                type="text"
				@click="$router.push({name:'Payment',params:{payId:scope.row.payId}})"
                >查看</el-button
              >
			...
			handleDelete() {
				...
				this.$confirm('此操作将永久删除文件，是否继续？', '提示', {
					...
					for (let i = 0; i < this.multipleSelection.length; i++)
						...
						console.log(ids)
					this.axios({
						url: "http://localhost:8089/eims/payment/batch",
						method: "delete",
						data: ids
					}).then(response => {
						this.loadData()
